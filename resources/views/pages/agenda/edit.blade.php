...
<?php
    $pageTitle = "Edit Agenda"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Agenda</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class="card card-1 border rounded page-content" >
                        ...
                        <div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="gbr_utama">Gbr Utama <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-gbr_utama-holder" class=" ">
                                            <input id="ctrl-gbr_utama" data-field="gbr_utama"  value="<?php  echo $data['gbr_utama']; ?>" type="text" placeholder="Enter Gbr Utama"  required="" name="gbr_utama"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-keterangan-holder" class=" ">
                                            <input id="ctrl-keterangan" data-field="keterangan"  value="<?php  echo $data['keterangan']; ?>" type="text" placeholder="Enter Keterangan"  required="" name="keterangan"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
