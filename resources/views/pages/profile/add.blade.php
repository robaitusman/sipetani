...
<?php
    $pageTitle = "Add New Profile"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Profile</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="profile-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('profile.store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="code_otp">Code Otp </label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-code_otp-holder" class=" ">
                                                <input id="ctrl-code_otp" data-field="code_otp"  value="<?php echo get_value('code_otp') ?>" type="text" placeholder="Enter Code Otp"  name="code_otp"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
