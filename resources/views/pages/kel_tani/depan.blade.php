...
<div  class="mb-3" >
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-6 comp-grid " >
                <form method="get" action="" class="form">
                    <?php $rec_count = $comp_model->getcount_keltani();  ?>
                    <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("kel_tani") ?>' >
                    <div class="row gutter-sm align-items-center">
                        ...
                        <div class="col">
                            <div class="flex-column justify-content align-center">
                                <div class="title">Kel Tani</div>
                                <small class="">Total Kel Tani</small>
                            </div>
        ...
        <div class="col-md-6 comp-grid " >
            ...
            @include("pages.kios_daging-depan-jumlah-kelompok-tani-berdasarkan-kelurahan")
        </div>
    </div>
</div>
</div>
                ...
                <div  class=" page-content" >
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <script>
                            ...
                            ["<?php echo  $data['nama_kelompok'] ; ?>",<?php echo  $data['lat'] ; ?>,<?php echo  $data['long'] ; ?>,"<?php echo  $data['jenis_hewan_nama_jenis'] ; ?>","<?php echo  $data['alamat'] ; ?>", "<?php echo  $data['wilayah_kelurahan'] ; ?>", " <?php echo  $data['wilayah_kecamatan'] ; ?>", " <?php echo  $data['kapasitas'] ; ?>"],
                            <?php } ?>
                            ];
                            console.log(points);
                        ...
                        <div id="kel_tani-depan-records">
                            <div class="row gutter-lg ">
                                <div class="col">
                                    <div id="page-main-content" class="table-responsive">
                                        <?php Html::page_bread_crumb("/kel_tani/depan", $field_name, $field_value); ?>
                                        <table class="table table-hover table-striped table-sm text-left">
                                            <thead class="table-header ">
                                                <tr>
                                                    <th class="td-" > </th><th class="td-nama_kelompok" > Nama Kelompok</th>
