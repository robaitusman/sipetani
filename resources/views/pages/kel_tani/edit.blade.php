...
<?php
    $pageTitle = "Edit Kel Tani"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Kel Tani</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <div class="row gutter-lg ">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("kel_tani/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-nama_kelompok-holder" class=" ">
                                                    <input id="ctrl-nama_kelompok" data-field="nama_kelompok"  value="<?php  echo $data['nama_kelompok']; ?>" type="text" placeholder="Enter Nama Kelompok"  required="" name="nama_kelompok"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-nama_ketua-holder" class=" ">
                                                    <input id="ctrl-nama_ketua" data-field="nama_ketua"  value="<?php  echo $data['nama_ketua']; ?>" type="text" placeholder="Enter Nama Ketua"  required="" name="nama_ketua"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-jumlah_anggota-holder" class=" ">
                                                    <input id="ctrl-jumlah_anggota" data-field="jumlah_anggota"  value="<?php  echo $data['jumlah_anggota']; ?>" type="number" placeholder="Enter Jumlah Anggota" step="any"  required="" name="jumlah_anggota"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-jenis-holder" class=" ">
                                                    <input id="ctrl-jenis" data-field="jenis"  value="<?php  echo $data['jenis']; ?>" type="text" placeholder="Enter Jenis"  required="" name="jenis"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
