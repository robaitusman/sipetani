...
<?php
    $pageTitle = "Edit Periode Evaluasi"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Periode Evaluasi</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("periodeevaluasi/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-tahun-holder" class=" ">
                                            <input id="ctrl-tahun" data-field="tahun"  value="<?php  echo $data['tahun']; ?>" type="text" placeholder="Enter Tahun"  required="" name="tahun"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_periode-holder" class=" ">
                                            <input id="ctrl-nama_periode" data-field="nama_periode"  value="<?php  echo $data['nama_periode']; ?>" type="text" placeholder="Enter Nama Periode"  required="" name="nama_periode"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-status_periode-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $field_value = $data['status_periode'];
                                                if(!empty($options)){
