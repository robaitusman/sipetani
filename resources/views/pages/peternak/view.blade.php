...
<?php
    ...
    $pageTitle = "Peternak Details"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Peternak Details</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-3 row row gutter-lg">
                            ...
                            <div class=" col-12 col-md-6">
                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">Wilayah Kelurahan</small>
                                            <div class="fw-bold">
