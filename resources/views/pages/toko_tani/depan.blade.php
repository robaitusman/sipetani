...
<?php
    ...
    $can_add = $user->canAccess("toko_tani/add");
    $can_edit = $user->canAccess("toko_tani/edit");
    $can_view = $user->canAccess("toko_tani/view");
    $can_delete = $user->canAccess("toko_tani/delete");
    ...
    $pageTitle = "Toko Tani"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Toko Tani</div>
                    </div>
                </div>
                <div class="col-md-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary" href="<?php print_link("toko_tani/add", true) ?>" >
...
<div  class="mb-3" >
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-6 comp-grid " >
                <form method="get" action="" class="form">
                    <?php $rec_count = $comp_model->getcount_tokotani();  ?>
                    <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("toko_tani") ?>' >
                    <div class="row gutter-sm align-items-center">
                        ...
                        <div class="col">
                            <div class="flex-column justify-content align-center">
                                <div class="title">Toko Tani</div>
                                <small class="">Total Toko Tani</small>
                            </div>
        ...
        <div class="col-md-6 comp-grid " >
            ...
            @include("pages.kios_daging-depan-jumlah-toko-tani-berdasarkan-kelurahan")
        </div>
    </div>
</div>
</div>
                ...
                <div  class=" page-content" >
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <script>
                            ...
                            ["<?php echo  $data['nama_usaha'] ; ?>",<?php echo  $data['lat'] ; ?>,<?php echo  $data['long'] ; ?>,"<?php echo  $data['jenis_hewan_nama_jenis'] ; ?>","<?php echo  $data['alamat'] ; ?>", "<?php echo  $data['wilayah_kelurahan'] ; ?>", " <?php echo  $data['wilayah_kecamatan'] ; ?>", " <?php echo  $data['kapasitas'] ; ?>"],
                            <?php } ?>
                            ];
                            console.log(points);
                        ...
                        <div id="toko_tani-depan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/toko_tani/depan", $field_name, $field_value); ?>
