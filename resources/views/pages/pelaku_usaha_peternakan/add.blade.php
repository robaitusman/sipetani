...
<?php
    $pageTitle = "Add New Pelaku Usaha Peternakan"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Pelaku Usaha Peternakan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="pelaku_usaha_peternakan-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('pelaku_usaha_peternakan.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-legalitas-holder" class=" ">
                                                <input id="ctrl-legalitas" data-field="legalitas"  value="<?php echo get_value('legalitas') ?>" type="text" placeholder="Enter Legalitas"  required="" name="legalitas"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-status_kelompok-holder" class=" ">
                                                <input id="ctrl-status_kelompok" data-field="status_kelompok"  value="<?php echo get_value('status_kelompok') ?>" type="text" placeholder="Enter Status Kelompok"  required="" name="status_kelompok"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-legalitas_produksi-holder" class=" ">
                                                <input id="ctrl-legalitas_produksi" data-field="legalitas_produksi"  value="<?php echo get_value('legalitas_produksi') ?>" type="text" placeholder="Enter Legalitas Produksi"  required="" name="legalitas_produksi"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jenis_olahan-holder" class=" ">
                                                <input id="ctrl-jenis_olahan" data-field="jenis_olahan"  value="<?php echo get_value('jenis_olahan') ?>" type="text" placeholder="Enter Jenis Olahan"  required="" name="jenis_olahan"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-komoditas-holder" class=" ">
                                                <input id="ctrl-komoditas" data-field="komoditas"  value="<?php echo get_value('komoditas') ?>" type="text" placeholder="Enter Komoditas"  required="" name="komoditas"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jml_produksi-holder" class=" ">
                                                <input id="ctrl-jml_produksi" data-field="jml_produksi"  value="<?php echo get_value('jml_produksi') ?>" type="number" placeholder="Enter Jml Produksi" step="any"  required="" name="jml_produksi"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-omzet-holder" class=" ">
                                                <input id="ctrl-omzet" data-field="omzet"  value="<?php echo get_value('omzet') ?>" type="number" placeholder="Enter Omzet" step="any"  required="" name="omzet"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-sumber_bahan_baku-holder" class=" ">
                                                <input id="ctrl-sumber_bahan_baku" data-field="sumber_bahan_baku"  value="<?php echo get_value('sumber_bahan_baku') ?>" type="text" placeholder="Enter Sumber Bahan Baku"  required="" name="sumber_bahan_baku"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-metode_penjualan-holder" class=" ">
                                                <input id="ctrl-metode_penjualan" data-field="metode_penjualan"  value="<?php echo get_value('metode_penjualan') ?>" type="text" placeholder="Enter Metode Penjualan"  required="" name="metode_penjualan"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
