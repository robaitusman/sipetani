...
<?php
    $pageTitle = "Edit Rph"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rph</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rph/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kapasitas-holder" class=" ">
                                            <input id="ctrl-kapasitas" data-field="kapasitas"  value="<?php  echo $data['kapasitas']; ?>" type="number" placeholder="Enter Kapasitas" step="any"  required="" name="kapasitas"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-gambar-holder" class=" ">
                                            <input id="ctrl-gambar" data-field="gambar"  value="<?php  echo $data['gambar']; ?>" type="text" placeholder="Enter Gambar"  required="" name="gambar"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-body-holder" class=" ">
                                            <textarea placeholder="Enter Body" id="ctrl-body" data-field="body"  required="" rows="5" name="body" class=" form-control"><?php  echo $data['body']; ?></textarea>
