...
<?php
    $pageTitle = "Edit Gudang Telur"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Gudang Telur</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("gudang_telur/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_unit_usaha-holder" class=" ">
                                            <input id="ctrl-nama_unit_usaha" data-field="nama_unit_usaha"  value="<?php  echo $data['nama_unit_usaha']; ?>" type="text" placeholder="Enter Nama Unit Usaha"  required="" name="nama_unit_usaha"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
