...
<?php
    ...
    $can_add = $user->canAccess("gudang_telur/add");
    $can_edit = $user->canAccess("gudang_telur/edit");
    $can_view = $user->canAccess("gudang_telur/view");
    $can_delete = $user->canAccess("gudang_telur/delete");
    ...
    $pageTitle = "Gudang Telur"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Gudang Telur</div>
                    </div>
                </div>
                <div class="col-md-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary" href="<?php print_link("gudang_telur/add", true) ?>" >
                    <i class="icon dripicons-plus"></i>                             
                    Add New Gudang Telur 
                </a>
                <?php } ?>
            </div>
            <div class="col-md-3  " >
...
<div  class="mb-3" >
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-6 comp-grid " >
                <form method="get" action="" class="form">
                    <?php $rec_count = $comp_model->getcount_gudangtelur();  ?>
                    <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("gudang_telur") ?>' >
                    <div class="row gutter-sm align-items-center">
                        ...
                        <div class="col">
                            <div class="flex-column justify-content align-center">
                                <div class="title">Gudang Telur</div>
                                <small class="">Total Gudang Telur</small>
                            </div>
        ...
        <div class="col-md-6 comp-grid " >
            ...
            @include("pages.kios_daging-depan-jumlah-gudang-telur-berdasarkan-kelurahan")
        </div>
    </div>
</div>
</div>
                ...
                <div  class=" page-content" >
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <script>
                            ...
                            ["<?php echo  $data['nama_unit_usaha'] ; ?>",<?php echo  $data['lat'] ; ?>,<?php echo  $data['long'] ; ?>,"<?php echo  $data['jenis_hewan_nama_jenis'] ; ?>","<?php echo  $data['alamat'] ; ?>", "<?php echo  $data['wilayah_kelurahan'] ; ?>", " <?php echo  $data['wilayah_kecamatan'] ; ?>", " <?php echo  $data['kapasitas'] ; ?>"],
                            <?php } ?>
                            ];
                            console.log(points);
                        ...
                        <div id="gudang_telur-depan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/gudang_telur/depan", $field_name, $field_value); ?>
                                <table class="table table-hover table-striped table-sm text-left">
                                    <thead class="table-header ">
                                        <tr>
                                            <th class="td-nama_unit_usaha" > Nama Unit Usaha</th>
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            <!--PageComponentStart-->
                                            <td class="td-nama_unit_usaha">
                                                <?php echo  $data['nama_unit_usaha'] ; ?>
                                            </td>
