...
<?php
    $pageTitle = "Add New Gudang Telur"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Gudang Telur</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="gudang_telur-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('gudang_telur.store') }}" method="post">
                            @csrf
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nama_unit_usaha">Nama Unit Usaha <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-nama_unit_usaha-holder" class=" ">
                                                <input id="ctrl-nama_unit_usaha" data-field="nama_unit_usaha"  value="<?php echo get_value('nama_unit_usaha') ?>" type="text" placeholder="Enter Nama Unit Usaha"  required="" name="nama_unit_usaha"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-keterangan-holder" class=" checkbox-group-required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
