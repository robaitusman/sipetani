...
<?php
    ...
    $can_add = $user->canAccess("bbi/add");
    $can_edit = $user->canAccess("bbi/edit");
    $can_view = $user->canAccess("bbi/view");
    $can_delete = $user->canAccess("bbi/delete");
    ...
    $pageTitle = "Bbi"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Bbi</div>
                    </div>
                </div>
                <div class="col-md-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary" href="<?php print_link("bbi/add", true) ?>" >
...
<div  class="mb-3" >
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-6 comp-grid " >
                <form method="get" action="" class="form">
                    <?php $rec_count = $comp_model->getcount_bbi();  ?>
                    <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("bbi") ?>' >
        ...
        <div class="col-md-6 comp-grid " >
            ...
            @include("pages.kios_daging-depan-jumlah-bbi-berdasarkan-kelurahan")
        </div>
    </div>
</div>
</div>
            ...
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <div id="bbi-depan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/bbi/depan", $field_name, $field_value); ?>
