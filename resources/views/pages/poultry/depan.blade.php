...
<section class="page" data-page-type="list" data-page-url="{{ url()->full() }}">
    ...
    <div  class="mb-3" >
        <div class="container-fluid">
            <div class="row ">
                <div class="col- col-6 comp-grid " >
                    <form method="get" action="" class="form">
                        <?php $rec_count = $comp_model->getcount_jumlahdatapoultry();  ?>
                        <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("poultry") ?>' >
                        <div class="row gutter-sm align-items-center">
                            ...
                            <div class="col">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Jumlah Data Poultry</div>
                                    <small class="">Total Poultry</small>
                                </div>
            ...
            <div class="col- col-6 comp-grid " >
                ...
                @include("pages.poultry-depan-jumlah-per-kelurahan")
            </div>
        </div>
    </div>
</div>
                    ...
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <script>
                            ...
                            "<table>"+
                                ...
                                "<tr><td>kapasitas</td><td>:</td><td>"+point[7] +"</td></tr>"+
                        ...
                        <div id="poultry-depan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/poultry/depan", $field_name, $field_value); ?>
