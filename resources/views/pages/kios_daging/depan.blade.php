    ...
    <div  class="mb-3" >
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-6 comp-grid " >
                    <form method="get" action="" class="form">
                        <?php $rec_count = $comp_model->getcount_kiosdaging();  ?>
                        <a class="animated zoomIn record-count alert alert-primary"  href='<?php print_link("kios_daging") ?>' >
                        <div class="row gutter-sm align-items-center">
                            ...
                            <div class="col">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Kios Daging</div>
                                    <small class="">Total Kios Daging</small>
                                </div>
                    ...
                    <div class="card q-mb-sm q-pa-sm ">
                        <div class="">
                            <div class="h4 font-weight-bold">Filter Wilayah</div>
                        </div>
            ...
            <div class="col-md-6 comp-grid " >
                ...
                @include("pages.kios_daging-depan-jumlah-kios-daging-berdasarkan-kelurahan")
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <link rel="stylesheet" media="all" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css">
                        ...
                        <div id="kios_daging-depan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/kios_daging/depan", $field_name, $field_value); ?>
