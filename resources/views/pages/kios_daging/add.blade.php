...
<?php
    $pageTitle = "Add New Kios Daging"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Kios Daging</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="kios_daging-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('kios_daging.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-kapasitas-holder" class=" ">
                                                <input id="ctrl-kapasitas" data-field="kapasitas"  value="<?php echo get_value('kapasitas') ?>" type="number" placeholder="Enter Kapasitas" step="any"  required="" name="kapasitas"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-kontak-holder" class=" ">
                                                <input id="ctrl-kontak" data-field="kontak"  value="<?php echo get_value('kontak') ?>" type="text" placeholder="Enter Kontak"  required="" name="kontak"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
