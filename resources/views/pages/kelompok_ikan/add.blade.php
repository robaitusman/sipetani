...
<?php
    $pageTitle = "Add New Kelompok Ikan"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Kelompok Ikan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="kelompok_ikan-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('kelompok_ikan.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.css" />
                                        ...
                                        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
                                            ...
                                            <script>
                                                ...
                                                layer = e.layer;
                                                drawnItems.addLayer(layer);
                                                const json = convertFormToJSON('#kelompok_ikan-add-form');
                                                delete json._token;
