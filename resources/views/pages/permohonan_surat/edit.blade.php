...
<?php
    $pageTitle = "Edit Permohonan Surat"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Permohonan Surat</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("permohonan_surat/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-status_surat-holder" class=" ">
                                            <input id="ctrl-status_surat" data-field="status_surat"  value="<?php  echo $data['status_surat']; ?>" type="number" placeholder="Enter Status Surat" step="any"  required="" name="status_surat"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kelengkapan_dokumen-holder" class=" ">
                                            <textarea placeholder="Enter Kelengkapan Dokumen" id="ctrl-kelengkapan_dokumen" data-field="kelengkapan_dokumen"  required="" rows="5" name="kelengkapan_dokumen" class=" form-control"><?php  echo $data['kelengkapan_dokumen']; ?></textarea>
