                                                ...
                                                <div class="mb-3 row row gutter-lg">
                                                    ...
                                                    <div class=" col-12 col-md-4">
                                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Forgot Exp</small>
                                                                    <div class="fw-bold">
                                                                        <?php echo  $data['forgot_exp'] ; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class=" col-12 col-md-4">
                                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Remember Time</small>
                                                                    <div class="fw-bold">
                                                                        <?php echo  $data['remember_time'] ; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class=" col-12 col-md-4">
                                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Remember Exp</small>
                                                                    <div class="fw-bold">
                                                                        <?php echo  $data['remember_exp'] ; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class=" col-12 col-md-4">
                                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Top Secret</small>
                                                                    <div class="fw-bold">
                                                                        <?php echo  $data['top_secret'] ; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
