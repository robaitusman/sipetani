...
<?php
    $pageTitle = "Edit Slider"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Slider</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("slider/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-deskripsi-holder" class=" ">
                                            <input id="ctrl-deskripsi" data-field="deskripsi"  value="<?php  echo $data['deskripsi']; ?>" type="text" placeholder="Enter Deskripsi"  required="" name="deskripsi"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-img_slider-holder" class=" ">
                                            <div class="dropzone required" input="#ctrl-img_slider" fieldname="img_slider" uploadurl="{{ url('fileuploader/upload/img_slider') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                <input name="img_slider" id="ctrl-img_slider" data-field="img_slider" required="" class="dropzone-input form-control" value="<?php  echo $data['img_slider']; ?>" type="text"  />
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                            </div>
                                        </div>
                                        <?php Html :: uploaded_files_list($data['img_slider'], '#ctrl-img_slider'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
