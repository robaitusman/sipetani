...
<?php
    ...
    $pageTitle = "Kelompok Ikan Hias Details"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Kelompok Ikan Hias Details</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="d-flex gap-1 justify-content-start">
                                <?php if($can_edit){ ?>
                                <a class="btn btn-sm btn-success has-tooltip "   title="Edit" href="<?php print_link("kelompok_ikan_hias/edit/$rec_id"); ?>" >
                                <i class="icon dripicons-document-edit"></i> Edit
                            </a>
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" title="Delete" href="<?php print_link("kelompok_ikan_hias/delete/$rec_id?redirect=kelompok_ikan_hias"); ?>" >
