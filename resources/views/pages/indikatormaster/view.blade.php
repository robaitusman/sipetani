...
<?php
    ...
    $pageTitle = "Indikator Master Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Indikator Master Details</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="page-data">
                                ...
                                <div class="mb-3 row row justify-content-start g-0">
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Sasaran Program</small>
                                                    <div class="fw-bold">
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Roles Role Id</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['roles_role_id'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Roles Role Name</small>
                                                    <div class="fw-bold">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <?php if($can_edit){ ?>
                                    <a class="btn btn-sm btn-success has-tooltip "   title="Edit" href="<?php print_link("indikatormaster/edit/$rec_id"); ?>" >
                                    <i class="icon dripicons-document-edit"></i> Edit
                                </a>
                                <?php } ?>
                                <?php if($can_delete){ ?>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" title="Delete" href="<?php print_link("indikatormaster/delete/$rec_id?redirect=indikatormaster"); ?>" >
