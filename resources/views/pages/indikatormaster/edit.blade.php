...
<?php
    $pageTitle = "Edit Indikator Master"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Indikator Master</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("indikatormaster/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sasaran_program-holder" class=" ">
                                            <textarea placeholder="Enter Sasaran Program" id="ctrl-sasaran_program" data-field="sasaran_program"  required="" rows="5" name="sasaran_program" class=" form-control"><?php  echo $data['sasaran_program']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-indikator_kinerja-holder" class=" ">
                                            <textarea placeholder="Enter Indikator Kinerja" id="ctrl-indikator_kinerja" data-field="indikator_kinerja"  required="" rows="5" name="indikator_kinerja" class=" form-control"><?php  echo $data['indikator_kinerja']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-urutan-holder" class=" ">
                                            <input id="ctrl-urutan" data-field="urutan"  value="<?php  echo $data['urutan']; ?>" type="number" placeholder="Enter Urutan" step="any"  required="" name="urutan"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-is_active-holder" class=" ">
                                            <input id="ctrl-is_active" data-field="is_active"  value="<?php  echo $data['is_active']; ?>" type="number" placeholder="Enter Is Active" step="any"  required="" name="is_active"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
