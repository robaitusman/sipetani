    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                ...
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("indikatormaster/add", true) ?>" >
                    <i class="icon dripicons-plus"></i>                             
                    Add New Indikator Master 
                </a>
                <?php } ?>
            </div>
            <div class="col-md-3  " >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="indikatormaster-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/indikatormaster/", $field_name, $field_value); ?>
