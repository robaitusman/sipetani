...
<?php
    $pageTitle = "Add New Pelaku Usaha Tani"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-auto  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Pelaku Usaha Tani</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="pelaku_usaha_tani-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('pelaku_usaha_tani.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-status-holder" class=" ">
                                                ...
                                                <input class="form-check-input" <?php echo $checked; ?> value="<?php echo $value; ?>" type="checkbox" name="status[]"   />
                                                <span class="form-check-label"><?php echo $label; ?></span>
                                                </label>
                                                <?php
                                                    }
                                    ...
                                    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.css" />
                                        ...
                                        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
                                            ...
                                            <script>
                                                ...
                                                layer = e.layer;
                                                drawnItems.addLayer(layer);
                                                const json = convertFormToJSON('#pelaku_usaha_tani-add-form');
                                                delete json._token;
