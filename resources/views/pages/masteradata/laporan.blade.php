...
<?php
    ...
    $periodeSlug = \Illuminate\Support\Str::slug($periodeLabel ?? 'periode', '_');
    $tableId = 'laporan_adata_' . $periodeSlug;
            ...
            <div class="row ">
                <div class="col comp-grid " >
                    <div  class=" page-content" >
                        <div id="masteradata-laporan-records">
                            <div id="page-main-content" class="table-responsive">
                                <?php Html::page_bread_crumb("/masteradata/laporan", $field_name, $field_value); ?>
                                ...
                                <table id="{{ $tableId }}" class="table table-hover table-striped table-sm text-left">
                        ...
                        <th class="td-satuan" > Satuan</th>
                                            ...
                                            <th class="td-aksi text-center" > Status</th>
                                        </tr>
                                    </thead>
                                    <?php
                                        if($total_records){
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-elemen">
                                                <?php
                                                    $elemenText = preserveIndentation($data['elemen']);
                                                    echo (isset($data['is_input']) && $data['is_input'] == 0)
                                                        ? '<strong>' . $elemenText . '</strong>'
                                                        : $elemenText;
                                                ?>
                                            </td>
                                            <td class="td-satuan">
                                            ...
                                            <td class="td-aksi text-center">
                                                <?php if($hasEvaluasi){ ?>
                                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                                        ...
                                                        <a href="{{ url('evaluasiadata/edit/' . $data['evaluasi_id']) }}"
...
<!-- Hardcode script + CDN so exportTable tersedia -->
...
function exportTable(tableId, format = 'csv', label = 'laporan') {
    ...
    const safeLabel = label
        ...
        : tableId;
    const fileName = `${safeLabel || tableId}.${extension}`;
