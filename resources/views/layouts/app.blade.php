...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCkcwuRCBoYwTyC4wBpbpLIe7xj8hpAGLs "></script>
    <script src="/js/jquery-map/dist/jquery.addressPickerByGiro.js"></script>
    <link href="/js/jquery-map/dist/jquery.addressPickerByGiro.css" rel="stylesheet" media="screen">
	...
	<body id="<?php echo $body_id ?>" class="with-login <?php echo $body_class ?>">
		<div class="{{ !auth()->check() ? 'container' : '' }}" id="page-wrapper">
