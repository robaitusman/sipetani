...
class Pupo extends Model 
{
     ...
     */
	protected $fillable = [
		'nik','nama_pemilik','nama_usaha','nama_produk','alamat','id_wilayah','rt','rw','visibility','status','photo','lokasi','long','lat','penulis'
	];
	...
	public static function search($query, $text){
		...
		$search_condition = '(
				pupo.nik LIKE ?  OR 
				pupo.nama_pemilik LIKE ?  OR 
				pupo.nama_usaha LIKE ?  OR 
				pupo.alamat LIKE ?  OR 
				pupo.rt LIKE ?  OR 
				pupo.rw LIKE ?  OR 
				pupo.lokasi LIKE ?  OR 
	...
	public static function listFields(){
		return [ 
			"pupo.id_pupo AS id_pupo",
			"pupo.nik AS nik",
			"pupo.nama_pemilik AS nama_pemilik",
			"pupo.nama_usaha AS nama_usaha",
			"pupo.alamat AS alamat",
			"pupo.rt AS rt",
			"pupo.rw AS rw",
			"pupo.lokasi AS lokasi",
	...
	public static function viewFields(){
		return [ 
			...
			"pupo.nama_pemilik AS nama_pemilik",
			"pupo.nama_usaha AS nama_usaha",
			"pupo.nama_produk AS nama_produk",
			"pupo.alamat AS alamat",
			"pupo.id_wilayah AS id_wilayah",
			"pupo.rt AS rt",
			"pupo.rw AS rw",
			"pupo.id_map AS id_map",
			"pupo.visibility AS visibility",
			"pupo.status AS status",
			"pupo.created_at AS created_at",
			"pupo.photo AS photo",
			"pupo.lokasi AS lokasi",
			"pupo.long AS long",
			"pupo.lat AS lat",
			"pupo.penulis AS penulis",
			"wilayah.id_wilayah AS wilayah_id_wilayah",
			"wilayah.kelurahan AS wilayah_kelurahan",
			"wilayah.kecamatan AS wilayah_kecamatan",
			"aauth_users.id AS aauth_users_id",
