...
class Tpi extends Model 
{
	...
	public static function search($query, $text){
		...
		$search_condition = '(
				...
				tpi.kapasitas LIKE ?  OR 
				tpi.ket_legalitas LIKE ?  OR 
				tpi.long LIKE ?  OR 
				tpi.lat LIKE ?  OR 
	...
	public static function listFields(){
		return [ 
			"tpi.id AS id",
			"tpi.nama AS nama",
			"tpi.alamat AS alamat",
			"tpi.rt AS rt",
			"tpi.rw AS rw",
			"tpi.lokasi AS lokasi",
	...
	public static function viewFields(){
		return [ 
			"tpi.id AS id",
			"tpi.nama AS nama",
			"tpi.kapasitas AS kapasitas",
			"tpi.alamat AS alamat",
			"tpi.id_wilayah AS id_wilayah",
			"tpi.rt AS rt",
			"tpi.rw AS rw",
			"tpi.id_map AS id_map",
			"tpi.legalitas AS legalitas",
			"tpi.ket_legalitas AS ket_legalitas",
			"tpi.visibility AS visibility",
			"tpi.status AS status",
			"tpi.created_at AS created_at",
			"tpi.photo AS photo",
			"tpi.lokasi AS lokasi",
			"tpi.long AS long",
			"tpi.lat AS lat",
			"tpi.penulis AS penulis",
			"wilayah.id_wilayah AS wilayah_id_wilayah",
			"wilayah.kelurahan AS wilayah_kelurahan",
			"wilayah.kecamatan AS wilayah_kecamatan",
			"aauth_users.id AS aauth_users_id",
